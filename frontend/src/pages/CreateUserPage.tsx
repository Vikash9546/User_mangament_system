          ...
          <Card title="Personal Snapshot" icon={User}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <input name="name" required minLength={3} maxLength={100} placeholder="e.g. Vikash Kumar" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
              <div>
              ...
              <div>
                ...
                <input name="placeOfBirth" required placeholder="Tell us in which City, Country the magic happens..." className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
            </div>
          </Card>
          ...
          <Card title="Contact Hub" icon={AtSign}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <input name="email" type="email" required placeholder="vikash.kumar@gmail.com" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
              <div>
                ...
                <input name="primaryMobile" required pattern="^\d{10}$" placeholder="+91 9876543210" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
              <div>
                ...
                <input name="secondaryMobile" pattern="^\d{10}$" placeholder="+91 9876543210" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
            </div>
          </Card>
