...
export default function UsersPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 bg-gradient-to-br from-pink-50 via-white to-white p-4 rounded-xl shadow-sm border border-pink-50 dark:bg-none dark:bg-gray-800 dark:border-gray-700 transition-colors duration-300">
      ...
      <div className="bg-gradient-to-br from-pink-50 via-white to-white rounded-xl shadow-sm border border-pink-100 overflow-hidden dark:bg-none dark:bg-gray-800 dark:border-gray-700 transition-colors duration-300">
