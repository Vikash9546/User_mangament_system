...
const Card = ({ title, icon: Icon, children }: any) => (
  <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden mb-6 dark:bg-gray-800 dark:border-gray-700 transition-colors duration-300">
    <div className="bg-pink-50 border-b border-gray-200 px-6 py-4 flex items-center gap-3 dark:bg-gray-800 dark:border-gray-700 transition-colors duration-300">
...
export default function EditUserPage() {
  ...
  if (isLoading) return <div className="min-h-screen bg-pink-50 flex items-center justify-center dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300">Loading...</div>;
  if (!user) return <div className="min-h-screen bg-pink-50 flex items-center justify-center dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300">User not found</div>;
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form id="user-form" onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card title="Personal Information" icon={User}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <input name="name" defaultValue={user.name} required minLength={3} maxLength={100} placeholder="e.g. Johnathan Doe" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
              <div>
                ...
                <input name="dateOfBirth" defaultValue={new Date(user.dateOfBirth).toISOString().split('T')[0]} type="date" required onClick={(e) => (e.target as HTMLInputElement).showPicker()} className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow cursor-pointer dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400 [color-scheme:light] dark:[color-scheme:dark]" />
              </div>
              <div>
                ...
                <input name="placeOfBirth" defaultValue={user.placeOfBirth} required placeholder="City, Country" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
            </div>
          </Card>
          ...
          <Card title="Contact Details" icon={AtSign}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <input name="email" defaultValue={user.email} type="email" required placeholder="j.doe@enterprise.com" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
              <div>
                ...
                <input name="primaryMobile" defaultValue={user.primaryMobile} required pattern="^\d{10}$" placeholder="+1 (555) 000-0000" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
              <div>
                ...
                <input name="secondaryMobile" defaultValue={user.secondaryMobile || ''} pattern="^\d{10}$" placeholder="+1 (555) 000-0000" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
            </div>
          </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input 
                  ...
                  className={`w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:text-gray-100 ${aadhaarStatus ? (aadhaarStatus.valid && !aadhaarStatus.exists ? 'border-green-500 bg-green-50 dark:bg-green-900/20' : 'border-red-500 bg-red-50 dark:bg-red-900/20') : 'border-gray-300 dark:border-gray-600 dark:bg-gray-700'}`}
                />
                {aadhaarStatus && (
            ...
            <div className="space-y-6">
              <div>
                ...
                <textarea 
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400"
                ></textarea>
              </div>
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <label className="flex items-center gap-2 text-sm text-gray-600 cursor-pointer dark:text-gray-400">
                    <input type="checkbox" checked={isSameAddress} onChange={handleCheckboxChange} className="rounded border-gray-300 text-pink-600 focus:ring-pink-500 dark:border-gray-600 dark:bg-gray-700" />
                    Same as current
                  </label>
                </div>
                <textarea 
                  ...
                  className={`w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:text-gray-100 dark:border-gray-600 dark:focus:ring-pink-400 dark:focus:border-pink-400 ${isSameAddress ? 'bg-pink-50 dark:bg-gray-800' : 'dark:bg-gray-700'}`}
                ></textarea>
              </div>
            </div>
          </Card>
          ...
          <div className="flex justify-end gap-4 mt-8">
            <button type="button" onClick={() => navigate(-1)} className="px-6 py-2.5 border border-gray-300 text-gray-700 bg-white rounded-lg hover:bg-pink-50 font-medium transition-all duration-200 hover:-translate-y-0.5 active:scale-95 dark:border-gray-600 dark:text-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700">Cancel</button>
