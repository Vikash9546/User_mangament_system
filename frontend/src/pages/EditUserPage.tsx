          ...
          <Card title="Personal Information" icon={User}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <input name="name" defaultValue={user.name} required minLength={3} maxLength={100} placeholder="e.g. Johnathan Doe" className="w-full px-4 py-2 border border-pink-200 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
              <div>
              ...
              <div>
                ...
                <input name="placeOfBirth" defaultValue={user.placeOfBirth} required placeholder="City, Country" className="w-full px-4 py-2 border border-pink-200 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
            </div>
          </Card>
          ...
          <Card title="Contact Details" icon={AtSign}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <input name="email" defaultValue={user.email} type="email" required placeholder="j.doe@enterprise.com" className="w-full px-4 py-2 border border-pink-200 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
              <div>
                ...
                <input name="primaryMobile" defaultValue={user.primaryMobile} required pattern="^\d{10}$" placeholder="+1 (555) 000-0000" className="w-full px-4 py-2 border border-pink-200 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
              <div>
                ...
                <input name="secondaryMobile" defaultValue={user.secondaryMobile || ''} pattern="^\d{10}$" placeholder="+1 (555) 000-0000" className="w-full px-4 py-2 border border-pink-200 rounded-md focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-shadow dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:focus:ring-pink-400 dark:focus:border-pink-400" />
              </div>
            </div>
          </Card>
